...
const external_zlib_namespaceObject = __nccwpck_require__(761);
...
const external_crypto_namespaceObject = __nccwpck_require__(417);
...
const external_url_namespaceObject = __nccwpck_require__(835);
...
// EXTERNAL MODULE: ./node_modules/csv-parse/lib/sync.js
var sync = __nccwpck_require__(750);
var sync_default = /*#__PURE__*/__nccwpck_require__.n(sync);
...
async function getInputs(defaultContext) {
  return {
...
async function getInputList(name, ignoreComma = false) {
  let res = [];
  ...
  for (let output of (await sync_default()(items, {
    columns: false,
    relax: true,
...
const { default: fetch } = __nccwpck_require__(746);
