...
function getInputList(name, ignoreComma) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const data = yield (0, sync_1.default)(items, {
            columns: false,
            relax: true,
...
(() => __awaiter(void 0, void 0, void 0, function* () {
    const { rancher, tags, serviceName, namespaceId } = yield (0, context_1.getInputs)();
...
class Rancher {
    ...
    fetchProjectsAsync() {
        return __awaiter(this, void 0, void 0, function* () {
            const req = yield fetch(`${this.rancherUrlApi}/projects`, {
                method: 'GET',
    ...
    fetchProjectWorkloadsAsync(projectId) {
        return __awaiter(this, void 0, void 0, function* () {
            const req = yield fetch(`${this.rancherUrlApi}/projects/${projectId}/workloads`, {
                method: 'GET',
                headers: this.headers
            });
            return req.json();
    ...
    changeImageAsync(workloadURL, namespaceId, config) {
        return __awaiter(this, void 0, void 0, function* () {
            const req = yield fetch(workloadURL, { method: 'GET', headers: this.headers });
            if (req.status === 404) {
                const data = {
                    containers: [
                ...
                yield fetch(workloadURL + '?action=redeploy', {
                    method: 'PUT',
                    headers: this.headers,
                    body: JSON.stringify(data)
                });
